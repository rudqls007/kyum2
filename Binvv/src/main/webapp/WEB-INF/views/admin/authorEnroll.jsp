...
<body>
                ...
                <div class="admin_content_wrap">
                    <div class="admin_content_subject"><span>작가 등록</span></div>
                      <div class="admin_content_main">
                    	...
                    	<!-- action 속성 값에 작가등록 기능을 수행하는 url을 작성하였고, 해당 url 매핑 메서드가 POST 방식이기 때문에
                    		method 속성 값을 POST로 작성하였다. -->
 ...
 <script type="text/javascript">
 	...
 	$("#enrollBtn").click(function() {
		$("#enrollForm").submit();
	}); // 작가 등록 버튼을 누르면 작가 등록 기능이 실행되도록 작성하였음.
 	
 	/* 취소 버튼 */
 	$("#cancelBtn").click(function() {
		location.href="/admin/authorManage"
	});	// 취소 버튼을 누르면 작가 관리 페이지로 이동하도록 함.
 </script>
</body>
</html>